  ...
  return (
    <section className="mt-8 mb-12">
      <div className="relative h-48 rounded-2xl overflow-hidden bg-gray-800" data-location="Los Angeles, USA" style={{backgroundImage: `url(${map})`}}>
        <div className="absolute inset-0 grayscale opacity-40 mix-blend-overlay" data-alt="Stylized city map background" style={{backgroundImage: `url(${map2}}), background-size: cover;`}}>
        </div>
